...
process percent_gc {
    script:
    """
    ${params.bin_dir}/percent_gc --input ${params.i_file_path} --output_bsml ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.bsml --sourcename ${params.output_directory}/${params.iterator_name} --class ${params.class}
    """
}

...
process tRNAscan_SE_compress {
    script:
    """
    ${params.trnascanse_exec} -q ${params.other_opts} -b -${params.search_type} ${params.i_file_path} \
...
process compress_raw_output {
    script:
    """
    ${params.bin_dir}/compress_file --file ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.raw --compress 1 --list_file ${params.tmp_dir}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.raw.list
    """
}

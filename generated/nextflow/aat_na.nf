...
process gap2 {
    script:
    """
    ${params.gap2_exec} ${params.i_file_path} ${params.gap2_database_path} ${params.tmp_dir}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.filter.raw ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.gap2.btab ${params.gap2_opts} \

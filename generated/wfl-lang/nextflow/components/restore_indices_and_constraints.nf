...
// Component: restore_indices_and_constraints
...
process Convert_DDL_to_iterator__for_chado_indices_and_constraints_ {
    script:
    """
...
process Convert_DDL_to_iterator__for_chado_mart_indices_and_constraints_ {
    script:
    """
...
workflow {
    ...
    Convert_DDL_to_iterator__for_chado_indices_and_constraints_()
    Convert_DDL_to_iterator__for_chado_mart_indices_and_constraints_()
}

...
process quicktree {
    script:
    """
    ${params.quicktree_exec} -in ${params.input_type}  -out t ${params.quicktree_opts} ${params.i_file_path} \
        1>${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.raw
    """
}

process quicktree2bsml {
    script:
    """
    ${params.bin_dir}/quicktree2bsml --quicktree_input ${params.i_file_path} --quicktree_output ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.raw --output ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.bsml --class polypeptide
    """
}

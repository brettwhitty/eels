...
process run_tblastn_ {
    script:
    """
    ${params.bin_dir}/run_blast_plus --blast_plus_bin ${params.blastplus_bin} --blast_type tblastn --query ${params.i_file_path} --db ${params.database_path} --remote ${params.remote} --evalue ${params.expect} --max_target_seqs ${params.max_target_seqs} --out ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.raw --other_opts ${params.other_opts} \
...
process store_config_params {
    script:
    """
    ${params.bin_dir}/analysis2bsml --ergatis_control_file ${params.ergatis_dir}.ini --conf ${params.component_config} --bsml_file ${params.output_directory}/${params.iterator_name}/g${params.group_number}/${params.i_file_base}.${params.component_name}.bsml --componenturl ${params.workflow_repository}/component.xml --pipelineurl ${params.repository_root}/workflow/runtime/pipeline/${params.pipelineid}/pipeline.xml --analysis_id tblastn_analysis
    """
}

...
process ncbi_blastp {
    script:
    """
    ${params.blastall_exec} -p blastp -i ${params.i_file_path} -d ${params.database_path} -e ${params.expect} -F '${params.filter}' -b ${params.database_matches} -v ${params.descriptions} -M ${params.matrix} ${params.other_opts} \

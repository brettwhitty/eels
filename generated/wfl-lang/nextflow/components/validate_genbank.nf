...
process validate_genbank {
    script:
    """
    ${params.bin_dir}/validate_genbank --genbank_file ${params.i_file_path} --output_path ${params.output_directory}/${params.iterator_name}/g${params.group_number}/ \
